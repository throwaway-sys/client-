  ...
  return (
    ...
    >
      <Paper elevation={3} sx={{ p: 3 }}>
        <Typography variant="h4">Total Users Registered</Typography>
        <Box
          sx={{
            display: 'flex',
            alignItems: 'center',
      ...
      <Paper elevation={3} sx={{ p: 3 }}>
        <Typography variant="h4">Total Rooms Registered</Typography>
        <Box
          sx={{
            display: 'flex',
            alignItems: 'center',
      ...
      <Paper elevation={3} sx={{ p: 2, gridColumn: 3, gridRow: '1/4' }}>
        <Box>
          <Typography>New Users Added</Typography>
          <List>
        ...
        <Box>
          <Typography>New Rooms Added</Typography>
          <List>
